...
Description: This is a library of classes built for reinforcement learning
on OpenStreetMap data to better appoximate a solution for the Travelling Salesman
Problem.
'''
